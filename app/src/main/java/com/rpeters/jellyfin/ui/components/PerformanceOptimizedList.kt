    ...
    return remember {
        ...
        when {
            maxMemoryMB > 512 && availableProcessors >= 8 -> {
                ...
                PerformanceSettings(
                    maxVisibleItems = 200,
                    imageQuality = com.rpeters.jellyfin.ui.image.ImageQuality.HIGH,
            ...
            maxMemoryMB > 256 && availableProcessors >= 4 -> {
                ...
                PerformanceSettings(
                    maxVisibleItems = 100,
                    imageQuality = com.rpeters.jellyfin.ui.image.ImageQuality.MEDIUM,
                    enableImagePreloading = true,
                    enableAnimations = true,
                    preloadOffset = 10,
                )
                ...
                PerformanceSettings(
                    maxVisibleItems = 50,
                    imageQuality = com.rpeters.jellyfin.ui.image.ImageQuality.LOW,
...
data class PerformanceSettings(
    ...
    val imageQuality: com.rpeters.jellyfin.ui.image.ImageQuality,
